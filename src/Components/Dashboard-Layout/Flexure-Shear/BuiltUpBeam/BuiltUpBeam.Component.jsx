...
const BuiltUpBeamDesign = ()=> {
    ...
    useEffect(()=> {
        setResults({
            ...
            Fv: fv * (KD * KH * KSv * KT),
            Qr: (phi_cp * fcp * KD * KScp * KT) * (n * b * bearingLength) * KB * KZcp * ( 10 ** -3),
            An: n * b * (d - dn),
            Vr: (phi_v * fv * (KD * KH * KSv * KT) * ((2/3)* (An)) * KZv) / (10 ** 3),
            Ff: ff * (KD * KH * KSf * KT),
            Fr: phi_f * (ff * (KD * KH * KSf * KT)) * (n * b * d) * KN * (10 ** -3),
            delta_Limit: (beamSpan - bearingLength) / 360,
            I: n * (b * (d ** 3)) /12,
            EsI: n * E * (KSE * KT) * ((b * (d ** 3)) /12),
            delta: ((5 * (serviceLoading * tributaryWidth) * (beamSpan ** 4)) / (384 * E * (KSE * KT) * ((n * b * (d ** 3)) /12))) * ( 10 ** -3),
    ...
    return (
        <Fragment>
            ...
            <div className="main-info-column">
                <h1>Built-up Beam Design</h1>
                <form onSubmit={handleFormSubmit} >
                    <div className="form-group">
                        <label htmlFor="numberOfPlies">Number of Plies</label>
                        <input
                            name="numberOfPlies"
                            value={numberOfPlies} 
                            onChange={e => onChange(e)}
                            type="number" 
                            placeholder="# of Plies" />
                    </div>
                    <div className="form-group">
                       ...
                       <div className="info-card info-card-primary">
                            <div className="card-body">
                                ...
                                <div className="card-text">
                                    <p>Specie: {specie}</p>
                                    <p>Grade: {grade}</p>
                                    <p>n = {n}<span className="ml-2"> number of plies</span></p>
                        ...
                        <div className="info-card info-card-primary">
                            <div className="card-body">
                                ...
                                <div className="card-text">
                                    ...
                                    <p><Tex>{`A_n = n \\cdot  b \\cdot (d - d_n) `}</Tex><span className='ml-3'>net cross-sectional area</span></p>
                        ...
                        <div className="info-card info-card-primary">
                            <div className="card-body">
                                ...
                                <div className="card-text">
                                    <p><Tex>{`S = n \\cdot  \\dfrac{b \\cdot d^2}{6}`}</Tex></p>
                        ...
                        <div className="info-card info-card-primary">
                            <div className="card-body">
                                ...
                                <div className="card-text">
                                    ...
                                    <p><Tex>{`A_g = ${ (n * b * d).toFixed(2) } \\text{ mm}^2`}</Tex></p>
                        ...
                        <div className="info-card info-card-primary">
                            <div className="card-body">
                                ...
                                <div className="card-text">
                                    <p><Tex>{`\\text{Br}_{\\text{width}} = n \\cdot b`}</Tex><span className='ml-3'>bearing width</span></p>
                                    <p><Tex>{`\\text{Br}_{\\text{width}} = ${(n * b).toFixed(2)} \\text{ mm}`}</Tex></p>
                                    ...
                                    <p><Tex>{`A_b = ${(n * b * bearingLength).toFixed(2)} \\text{ mm}^2 `}</Tex></p>
...
export default BuiltUpBeamDesign;